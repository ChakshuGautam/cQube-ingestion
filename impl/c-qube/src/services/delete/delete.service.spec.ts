...
import * as multiple_old from '../../../test/fixtures/outputDatasets/update/multiple_old.json';
import * as multiple_updated from '../../../test/fixtures/outputDatasets/update/multiple_updated.json';
